...
FROM (
      ...
      Distinct
       ...
       LEFT JOIN CIERREN_ETL.TLSISGRAL_ETL_VAL_MATRIZ_CONV  C 
          ON DPSJL.FTC_FOLIO=C.FTC_FOLIO 
      WHERE DPSJL.FTC_ESTATUS=1
...
where FTC_FOLIO=201909231207430507
and FTN_ESTATUS<>0
...
WHERE  DPSJL.FTC_FOLIO = 201909231207430507
) CI
