...
SELECT 
DEVIN.FTN_CTA_AFORE         FTN_NUM_CTA_INVDUAL
,NULL                  FTN_IND_SDO_DISP
,DEVIN.FTN_AIVS_VIV_97       FTN_SDO_AIVS
,DEVIN.FTN_SALDO_97          FTN_MONTO_PESOS
,DEVIN.FTN_INTERES_SALDO_97  FTN_NUM_APLI_INTE_VIV
,NULL                  FTN_SALDO_VIV
,DEVIN.FTC_ESTATUS           FCN_ESTATUS
,DEVIN.FTC_FOLIO
,138 FCN_ID_REGIMEN
,15 AS FCN_ID_TIPO_SUBCTA
,DEVIN.FCN_ID_SUBPROCESO
FROM PROCESOS.TTAFOTRAS_DEVO_SALDO_EXC_INFO DEVIN
INNER JOIN  CIERREN_ETL.TLSISGRAL_ETL_VAL_MATRIZ_CONV C 
ON DEVIN.FTC_FOLIO=C.FTC_FOLIO
AND DEVIN.FTN_CTA_AFORE=C.FTN_NUM_CTA_INVDUAL
AND DEVIN.FCN_ID_SUBPROCESO=C.FCN_ID_SUBPROCESO
WHERE DEVIN.FTC_FOLIO = #sr_folio#
AND DEVIN.FCN_ID_SUBPROCESO=#sr_subproceso#
...
SELECT 
 DEVIN.FTN_CTA_AFORE         FTN_NUM_CTA_INVDUAL
,NULL                  FTN_IND_SDO_DISP
,DEVIN.FTN_AIVS_VIV_92       FTN_SDO_AIVS
,DEVIN.FTN_SALDO_92          FTN_MONTO_PESOS
,DEVIN.FTN_INTERES_SALDO_92  FTN_NUM_APLI_INTE_VIV
,NULL                  FTN_SALDO_VIV
,DEVIN.FTC_ESTATUS           FCN_ESTATUS
,DEVIN.FTC_FOLIO
,138 FCN_ID_REGIMEN
