...
SELECT
DISTINCT DEVFOV.FTN_NUM_CTA_INVDUAL        FTN_NUM_CTA_INVDUAL
,DEVFOV.FTC_FOLIO
,FTN_NUM_APLI_INTE_VIVI08 as FTN_SDO_AIVS
,FTN_SALDO_TOT_VIVI08 as  FTN_MONTO_PESOS
,139 FCN_ID_REGIMEN
,18 AS FCN_ID_TIPO_SUBCTA
,DEVFOV.FCN_ID_SUBPROCESO
FROM PROCESOS.TTAFOTRAS_DEVO_SALDO_EXC_FOV DEVFOV
INNER JOIN  CIERREN_ETL.TLSISGRAL_ETL_VAL_MATRIZ_CONV C 
ON DEVFOV.FTC_FOLIO=C.FTC_FOLIO
AND DEVFOV.FTN_NUM_CTA_INVDUAL=C.FTN_NUM_CTA_INVDUAL
AND DEVFOV.FCN_ID_SUBPROCESO=C.FCN_ID_SUBPROCESO
WHERE DEVFOV.FTC_FOLIO =#sr_folio#
AND DEVFOV.FCN_ID_SUBPROCESO=#sr_subproceso#
...
DISTINCT
 DEVFOV.FTN_NUM_CTA_INVDUAL        FTN_NUM_CTA_INVDUAL
,DEVFOV.FTC_FOLIO
