 ...
 ,A.FTN_CTA_AFORE  AS FTN_NUM_CTA_INVDUAL
...
FROM PROCESOS.TTAFOTRAS_DEVO_SALDO_EXC_INFO A
CROSS JOIN (
...
ON A.FTN_CTA_AFORE = BAL_MOVS.FTC_NUM_CTA_INVDUAL
...
group by A.FTC_FOLIO,A.FCN_ID_SUBPROCESO,A.FTN_CTA_AFORE 
