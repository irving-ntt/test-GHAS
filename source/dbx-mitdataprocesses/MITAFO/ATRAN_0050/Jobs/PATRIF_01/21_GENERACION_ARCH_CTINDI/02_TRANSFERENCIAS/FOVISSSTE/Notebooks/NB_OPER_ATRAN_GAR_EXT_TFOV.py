...
'''
Descripcion:
    Creación de archivo CTINDI para Transferencia de Acreditados Fovissste | Esta notebook corresponde a la estracción de los jobs: JP_PATRIF_0010_EXT_TRANSF_FOV, JP_PATRIF_GAC_0100_GEN_ARCH_CTINDI
Subetapa:
...
Tablas OUTPUT DELTA:
    N/A
Archivos SQL:
    CTINDI_FOV_EXT_0100_OCI_MOV_VIV.sql
    CTINDI_FOV_TRN_0200_DBK.sql
    DELETE.sql
'''
