...
DS_200_DATOS AS (
    SELECT DISTINCT
      ...
      lpad(t.ftn_num_cta_invdual,10,'0') as FTN_CTA_AFORE,
      lpad(nvl(T.FTC_NSS,'0'),11,'0') AS FTC_NSS_AFORE, 
      TRIM(IND.FTC_DIG_VERIF) AS FTC_DIG_VERI,
  ...
  BD_700_VALOR_ACCION AS (
    ...
    SELECT
      ...
      M.FND_FECTRA_SUA,
      B.FCN_VALOR_ACCION,
      D.FTC_INSTITUTO_ORIGEN
    FROM
      BD_100_TL_MOV_VIV M
      INNER JOIN DS_200_DATOS D ON M.FTC_FOLIO = D.FTC_FOLIO
