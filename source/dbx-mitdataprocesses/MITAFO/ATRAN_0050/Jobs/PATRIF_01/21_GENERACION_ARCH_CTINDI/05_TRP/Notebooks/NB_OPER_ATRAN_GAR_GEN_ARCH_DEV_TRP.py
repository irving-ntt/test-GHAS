...
'''
Descripcion:
    Creación de archivo CTINDI para Transferencia de Recursos por Portabilidad | Esta notebook corresponde al Job: JP_PATRIF_GAC_0200_GEN_ARC_CTINDI_TRP que genera el archivo
Subetapa:
...
Tablas OUTPUT DELTA:
    N/A
Archivos SQL:
    CTINDI_TRP_EXT_0300_OCI_GEN_ARCHIVO.sql
    CTINDI_TRP_TRN_0400_DBK_TRAN_GEN_ARCHIVO.sql
'''
