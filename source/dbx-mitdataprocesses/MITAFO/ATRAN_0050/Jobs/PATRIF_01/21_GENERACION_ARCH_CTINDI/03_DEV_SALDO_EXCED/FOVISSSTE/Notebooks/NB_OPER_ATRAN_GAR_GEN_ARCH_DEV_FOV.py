...
'''
Descripcion:
    Creación de archivo CTINDI para Devolución de Excedentes por T.A. Fovissste | Esta notebook corresponde al Job: JP_PATRIF_GAC_0200_GEN_ARC_CTINDI_FOV que genera el archivo
Subetapa:
...
Tablas OUTPUT DELTA:
    N/A
Archivos SQL:
    CTINDI_DEX_TA_BIS_EXT_0300_OCI_GEN_ARCHIVO.sql
    CTINDI_DEX_TA_BIS_TRN_0400_DBK_TRAN_GEN_ARCHIVO.sql
'''
