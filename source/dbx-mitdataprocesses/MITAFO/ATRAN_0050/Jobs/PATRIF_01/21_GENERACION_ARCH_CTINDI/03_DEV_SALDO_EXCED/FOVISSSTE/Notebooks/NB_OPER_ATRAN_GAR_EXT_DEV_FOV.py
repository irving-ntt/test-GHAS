...
'''
Descripcion:
    Creación de archivo CTINDI para Devolución de Excedentes por T.A. Fovissste | Esta notebook corresponde a la estracción de los jobs: JP_PATRIF_GAC_0100_EXT_DEV_FOV, JP_PATRIF_GAC_0100_GEN_ARCH_CTINDI
Subetapa:
...
Tablas INPUT:
    PROCESOS.TTAFOTRAS_DEVO_SALDO_EXC_FOV
...
Tablas OUTPUT DELTA:
    N/A
Archivos SQL:
    CTINDI_DEX_TA_BIS_EXT_0100_OCI_MOV_VIV.sql
    CTINDI_DEX_TA_BIS_TRN_0200_DBK.sql
    DELETE.sql
'''
