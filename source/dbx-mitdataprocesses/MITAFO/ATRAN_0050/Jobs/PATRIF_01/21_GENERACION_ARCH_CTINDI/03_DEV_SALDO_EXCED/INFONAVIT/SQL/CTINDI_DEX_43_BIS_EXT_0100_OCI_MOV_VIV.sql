WITH 
    ...
    SELECT
      FTC_FOLIO,
      LPAD(FTN_CTA_AFORE, 10, '0') AS FTN_CTA_AFORE,
      LPAD(NVL(FTC_NSS_AFORE, '0'), 11, '0') AS FTC_NSS_AFORE,
      SUBSTR(FTC_RFC_INFONA, 12, 1) AS FTC_DIG_VERI,
      TO_CHAR(FTD_FEH_CRE, 'YYYYMMDD') AS FTD_FEH_CRE,
      LPAD(NVL(FTN_ID_ARCHIVO, '0'), 7, '0') AS FTN_ID_ARCHIVO,
      FCN_ID_SUBPROCESO,
      LPAD(NVL(FTN_CONTA_SERV, '0'), 8, '0') AS FNN_ID_REFERENCIA,
      NULL AS FTC_INSTITUTO_ORIGEN
    FROM
