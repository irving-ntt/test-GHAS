...
LPAD(
  REPLACE(
  LPAD(SUBSTR(TO_CHAR(A.FTN_NUM_APLI_INTE_VIVI92_APL), 1, INSTR(TO_CHAR(A.FTN_NUM_APLI_INTE_VIVI92_APL, 'FM9999999999.99'), '.') - 1),9,'0') 
|| RPAD(SUBSTR(TRIM(TO_CHAR(A.FTN_NUM_APLI_INTE_VIVI92_APL, 'FM9999999999.999999')||'00'),INSTR(TRIM(TO_CHAR(A.FTN_NUM_APLI_INTE_VIVI92_APL, 'FM9999999999.999999')||'00'), '.') + 1, 6),6,'0')
  ,'.','')
          ,15,'0')
END AS AIVS92,
...
LPAD(
  REPLACE(
  LPAD(SUBSTR(TO_CHAR(A.FTN_SALDO_TOT_VIVI92_APL), 1, INSTR(TO_CHAR(A.FTN_SALDO_TOT_VIVI92_APL, 'FM9999999999.99'), '.') - 1),13,'0') 
|| RPAD(SUBSTR(TRIM(TO_CHAR(A.FTN_SALDO_TOT_VIVI92_APL, 'FM9999999999.99')||'00'),INSTR(TRIM(TO_CHAR(A.FTN_SALDO_TOT_VIVI92_APL, 'FM9999999999.99')||'00'), '.') + 1, 2),2,'0')
  ,'.','')
          ,15,'0')
END AS PESOS92,
...
LPAD(
  REPLACE(
  LPAD(SUBSTR(TO_CHAR(A.FTN_NUM_APLI_INTE_VIVI08_APL), 1, INSTR(TO_CHAR(A.FTN_NUM_APLI_INTE_VIVI08_APL, 'FM9999999999.99'), '.') - 1),9,'0') 
|| RPAD(SUBSTR(TRIM(TO_CHAR(A.FTN_NUM_APLI_INTE_VIVI08_APL, 'FM9999999999.999999')||'00'),INSTR(TRIM(TO_CHAR(A.FTN_NUM_APLI_INTE_VIVI08_APL, 'FM9999999999.999999')||'00'), '.') + 1, 6),6,'0')
  ,'.','')
          ,15,'0')
END AS AIVS08,
CASE WHEN A.FTC_ESTATUS = 0 THEN LPAD('0',20,'0')
...
LPAD(
  REPLACE(
  LPAD(SUBSTR(TO_CHAR(A.FTN_SALDO_TOT_VIVI08_APL), 1, INSTR(TO_CHAR(A.FTN_SALDO_TOT_VIVI08_APL, 'FM9999999999.99'), '.') - 1),13,'0') 
|| RPAD(SUBSTR(TRIM(TO_CHAR(A.FTN_SALDO_TOT_VIVI08_APL, 'FM9999999999.99')||'00'),INSTR(TRIM(TO_CHAR(A.FTN_SALDO_TOT_VIVI08_APL, 'FM9999999999.99')||'00'), '.') + 1, 2),2,'0')
  ,'.','')
          ,15,'0')
END AS PESOS08,
CASE WHEN A.FTC_ESTATUS = 1 
...
ORDER BY LPAD(A.FTN_CONTA_SERV,10,'0') ASC