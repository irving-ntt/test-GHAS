...
SELECT
  ...
  CASE 
    WHEN #SR_SUBPROCESO# = 364 THEN '#SR_PREFIJO_ARCH_TA_364##SR_FECHA_ACTUAL##SR_NOM_ARCHIVO_RECH_TA_364##SR_EXT_TXT#' 
    WHEN #SR_SUBPROCESO# = 365 THEN '#SR_PREFIJO_ARCH_AG_365##SR_FECHA_ACTUAL##SR_NOM_ARCHIVO_RECH_AG_365##SR_EXT_TXT#' 
    WHEN #SR_SUBPROCESO# = 368 THEN '#SR_PREFIJO_ARCH_UG_368##SR_FECHA_ACTUAL##SR_NOM_ARCHIVO_RECH_UG_368##SR_EXT_TXT#'
  END AS FTC_NOMBRE,
