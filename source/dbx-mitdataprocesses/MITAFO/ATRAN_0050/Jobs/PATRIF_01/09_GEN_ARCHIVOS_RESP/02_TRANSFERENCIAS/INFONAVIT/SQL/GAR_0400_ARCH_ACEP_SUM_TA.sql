...
ELSE   LPAD(
     REPLACE(
     LPAD(SUBSTR(TO_CHAR(FTN_NUM_AIVS_VIVI97_ULT), 1, INSTR(TO_CHAR(FTN_NUM_AIVS_VIVI97_ULT, 'FM9999999999.99'), '.') - 1),12,'0') 
   ||
   RPAD(
   SUBSTR(
   TRIM(
   TO_CHAR(FTN_NUM_AIVS_VIVI97_ULT, 'FM9999999999.999999')||'00'
   ),
   INSTR(
   TRIM(
   TO_CHAR(FTN_NUM_AIVS_VIVI97_ULT, 'FM9999999999.999999')||'00'
...
CASE WHEN FTN_SALDO_VIVI97_ULT IS NULL THEN LPAD('0',15,'0')
   ...
   LPAD(
     REPLACE(
    LPAD(SUBSTR(TO_CHAR(FTN_SALDO_VIVI97_ULT), 1, INSTR(TO_CHAR(FTN_SALDO_VIVI97_ULT, 'FM9999999999.99'), '.') - 1),13,'0') 
...
ELSE   LPAD(
     REPLACE(
     LPAD(SUBSTR(TO_CHAR(FTN_NUM_APLI_INTE_VIVI92_ENV), 1, INSTR(TO_CHAR(FTN_NUM_APLI_INTE_VIVI92_ENV, 'FM9999999999.99'), '.') - 1),12,'0') 
   ||RPAD(SUBSTR(TRIM(TO_CHAR(FTN_NUM_APLI_INTE_VIVI92_ENV, 'FM9999999999.999999')||'00')
   ,INSTR(TRIM(TO_CHAR(FTN_NUM_APLI_INTE_VIVI92_ENV, 'FM9999999999.999999')||'00'), '.') + 1, 6),6,'0'),'.','')
          ,18,'0') END AS FTN_NUM_APLI_INTE_VIVI92_ENV,
CASE WHEN FTN_SALDO_TOT_VIVI92 IS NULL THEN LPAD('0',15,'0')
   ELSE 
   LPAD(
REPLACE(
    LPAD(SUBSTR(TO_CHAR(FTN_SALDO_TOT_VIVI92), 1, INSTR(TO_CHAR(FTN_SALDO_TOT_VIVI92, 'FM9999999999.99'), '.') - 1),13,'0') 
...
CASE WHEN FTN_INTER_SALDO_VIVI97_ULT IS NULL THEN LPAD('0',15,'0')
   ...
   LPAD(
     REPLACE(
    LPAD(SUBSTR(TO_CHAR(FTN_INTER_SALDO_VIVI97_ULT), 1, INSTR(TO_CHAR(FTN_INTER_SALDO_VIVI97_ULT, 'FM9999999999.99'), '.') - 1),13,'0') 
...
CASE WHEN FTN_INTER_SALDO_VIVI92 IS NULL THEN LPAD('0',15,'0')
   ...
   LPAD(
     REPLACE(
    LPAD(SUBSTR(TO_CHAR(FTN_INTER_SALDO_VIVI92), 1, INSTR(TO_CHAR(FTN_INTER_SALDO_VIVI92, 'FM9999999999.99'), '.') - 1),13,'0') 
