...
,RPAD(substr((FTN_SDO_AIVS:: STRING),charindex('.',(FTN_SDO_AIVS:: STRING))+1,6),6,'0'),'1 ','2 ','MARIEL ','SI SIRVE',' HAY VA OTRO','  '
,(FTN_SDO_AIVS+1:: STRING),' ',((FTN_SDO_AIVS+2):: STRING),' ',((FTN_SDO_AIVS+10):: STRING)
...
FTC_FOLIO_BITACORA,
CASE WHEN FTN_SDO_AIVS == 0 THEN 0 ELSE CAST(FTN_SDO_AIVS AS DECIMAL(18,6)) END AS FTN_SDO_AIVS,
