...
SELECT
  ...
  AF.FTC_FOLIO,
  CASE 
    WHEN ARC.FCN_ID_SUBPROCESO = 364 THEN '#SR_PREFIJO_ARCH_TA_364##SR_FECHA_ACTUAL##SR_NOM_ARCHIVO_ACEPT_TA_364##SR_EXT_TXT#' 
    WHEN ARC.FCN_ID_SUBPROCESO = 365 THEN '#SR_PREFIJO_ARCH_AG_365##SR_FECHA_ACTUAL##SR_NOM_ARCHIVO_ACEPT_AG_365##SR_EXT_TXT#' 
    WHEN ARC.FCN_ID_SUBPROCESO = 368 THEN '#SR_PREFIJO_ARCH_UG_368##SR_FECHA_ACTUAL##SR_NOM_ARCHIVO_ACEPT_UG_368##SR_EXT_TXT#'
  END AS FTC_NOMBRE,
