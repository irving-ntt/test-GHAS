...
RPAD(' ',30,' ') AS FILLER,
 LPAD(
  REPLACE(
     LPAD(SUBSTR(TO_CHAR(FTN_SDO_AIVS), 1, INSTR(TO_CHAR(FTN_SDO_AIVS, 'FM9999999999.99'), '.') - 1),12,'0') 
   ...
   ,'.','')
          ,18,'0') AS FTN_SDO_AIVS,
 LPAD(
    REPLACE(
   LPAD(SUBSTR(TO_CHAR(FTN_MONTO_PESOS), 1, INSTR(TO_CHAR(FTN_MONTO_PESOS, 'FM9999999999.99'), '.') - 1),13,'0') 
  || RPAD(SUBSTR(TRIM(TO_CHAR(FTN_MONTO_PESOS, 'FM9999999999.99')||'00'),INSTR(TRIM(TO_CHAR(FTN_MONTO_PESOS, 'FM9999999999.99')||'00'), '.') + 1, 2),2,'0')
   ,'.','')
   ,15,'0') AS FTN_MONTO_PESOS,
RPAD(' ',656,' ') AS FILLER6
FROM
(
SELECT
