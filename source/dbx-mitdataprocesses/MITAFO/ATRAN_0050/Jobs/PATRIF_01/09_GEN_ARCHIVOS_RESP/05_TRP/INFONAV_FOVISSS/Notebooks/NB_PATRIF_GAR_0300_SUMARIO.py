...
# MAGIC /*
# MAGIC %md
# MAGIC NoteBook que genera el Sumario del archivo de respuesta del SubPoceso 3286 - Transferencia de Recursos por Portabilidad
# MAGIC */
...
temp_delta = 'DELTA_GAR_0300_SUMARIO' + '_' + params.sr_folio
