...
-- =====================================================================================
-- Transformación de datos para inserción (solo Delta) - Versión específica para subprocesos 348 y 349
...
SELECT 
    ...
    -- FTF_MONTO_PESOS_SOL (reglas específicas para 348 y 349)
    NVL(FTN_SALDO_VIV, 0) AS FTF_MONTO_PESOS_SOL,
    
    -- FTF_MONTO_ACCIONES_SOL (reglas específicas para 348 y 349)
    NVL(FTN_NUM_APLI_INTE_VIV, 0) AS FTF_MONTO_ACCIONES_SOL,
