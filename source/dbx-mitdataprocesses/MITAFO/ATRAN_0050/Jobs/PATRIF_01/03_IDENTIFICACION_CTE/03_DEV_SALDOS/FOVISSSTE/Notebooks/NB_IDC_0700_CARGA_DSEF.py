...
statement_2 = query.get_statement(
    ...
    DELTA_BUC=f"{SETTINGS.GENERAL.CATALOG}.{SETTINGS.GENERAL.SCHEMA}.DELTA_111_TRAMITE_{params.sr_folio}"
)
...
db.write_data(df_marca_700, "PROCESOS.TTAFOTRAS_DEVO_SALDO_EXC_FOV", "default", "append")
