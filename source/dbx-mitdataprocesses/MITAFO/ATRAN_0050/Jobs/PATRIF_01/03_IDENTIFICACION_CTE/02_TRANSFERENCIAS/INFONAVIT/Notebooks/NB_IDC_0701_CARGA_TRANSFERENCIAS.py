...
# MAGIC     DELTA_700_VIV_DUP_
# MAGIC Tablas
# MAGIC     PROCESOS.TTCRXGRAL_TRANS_INFONA
# MAGIC
...
statement_2 = query.get_statement(
    ...
    DELTA_BUC=f"{SETTINGS.GENERAL.CATALOG}.{SETTINGS.GENERAL.SCHEMA}.DELTA_200_BUC_TRA_{params.sr_folio}"
)
...
db.write_data(df_marca_700, "PROCESOS.TTCRXGRAL_TRANS_INFONA", "default", "append")
