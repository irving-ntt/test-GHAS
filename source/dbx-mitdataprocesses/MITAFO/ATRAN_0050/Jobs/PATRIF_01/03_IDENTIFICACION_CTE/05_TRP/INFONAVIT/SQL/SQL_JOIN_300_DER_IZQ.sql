SELECT DISTINCT
     ...
     IZQ.FTC_CURP                 ,
     IZQ.FTC_RFC                  ,
     IZQ.FTC_APELLIDO_PATERNO AS FTC_APELLIDO_PATER_AFORE ,
     IZQ.FTC_APELLIDO_MATERNO AS FTC_APELLIDO_MATER_AFORE ,
     IZQ.FTC_NOMBRE AS FTC_NOMBRE_AFORE         ,
     IZQ.FTC_CORREO_ELEC          ,
     IZQ.FTN_CELULAR              ,

     --IZQ.FTD_FEH_CRE,

     IZQ.FTC_INSTITUTO_ORIGEN     ,
