...
statement_1 = query.get_statement(
    ...
    #DELTA_TABLA_ENCONTRADOS=f"{SETTINGS.GENERAL.CATALOG}.{SETTINGS.GENERAL.SCHEMA}.DELTA_ENCONTRADOS_NSS_{params.sr_folio}",
    DELTA_TABLA_ENCONTRADOS=f"{SETTINGS.GENERAL.CATALOG}.{SETTINGS.GENERAL.SCHEMA}.DELTA_400_ENCONTRADOS_{params.sr_folio}",
