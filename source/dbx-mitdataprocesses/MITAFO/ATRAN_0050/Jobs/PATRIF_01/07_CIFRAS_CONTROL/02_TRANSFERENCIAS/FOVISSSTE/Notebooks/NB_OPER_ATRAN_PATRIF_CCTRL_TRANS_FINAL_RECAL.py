...
DELTA_DS_700 = "DELTA_700_ACT" + params.sr_folio
DELTA_JOIN = f"DELTA_400_SUBCTA_{params.sr_folio}"
DELTA_FL_400_SUBCTA = f"DELTA_TRANS_400_JOIN_{params.sr_id_archivo}"
