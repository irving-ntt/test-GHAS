...
statement = query.get_statement(
    "PATRIF_AIN_0100_ACT_IND_TRANF_INFO_SELECT_001.sql",
...
statement = query.get_statement(
    "PATRIF_AIN_0100_ACT_IND_TRANF_INFO_SELECT_002.sql",
    sr_folio=params.sr_folio,
    sr_subproceso=params.sr_subproceso,
    ind_vigencia=params.ind_vigencia,
    config_indi=params.config_indi
...
db.write_delta(f"DELTA_TRA_MARCA_UPDATE_002_{params.sr_folio}", db.read_data("default", statement), "overwrite")

if conf.debug:
    display(db.read_delta(f"DELTA_TRA_MARCA_UPDATE_002_{params.sr_folio}"))
...
db.write_data(db.read_delta(f"DELTA_TRA_MARCA_UPDATE_002_{params.sr_folio}"), table_name, "default", "append")

# COMMAND ----------

spark.sql(f"DROP TABLE IF EXISTS DELTA_TRA_MARCA_UPDATE_001_{params.sr_folio}")
spark.sql(f"DROP TABLE IF EXISTS DELTA_TRA_MARCA_UPDATE_002_{params.sr_folio}")
