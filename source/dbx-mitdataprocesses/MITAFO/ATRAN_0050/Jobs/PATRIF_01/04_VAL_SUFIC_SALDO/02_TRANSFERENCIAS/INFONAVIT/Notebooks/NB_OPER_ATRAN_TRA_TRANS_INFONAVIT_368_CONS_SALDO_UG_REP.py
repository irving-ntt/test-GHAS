...
statement = query.get_statement(
    "TRA_DB_ATRIF_VSS_0100_INFO_TRANS_368_DS_900_NSS_MULTIPLES_REP.sql",
...
statement = query.get_statement(
    "TRA_DB_ATRIF_VSS_0100_INFO_TRANS_368_DS_NSS_UNICO_REP.sql",
    sr_folio=params.sr_folio,
)
...
statement = query.get_statement(
    "TRA_DB_ATRIF_VSS_0100_INFO_TRANS_368_DS_600_RejInsSaldos_REP.sql",
    sr_folio=params.sr_folio,
)
...
statement = query.get_statement(
    "TRA_DB_ATRIF_368_BD_606_TL_PRO_SUF_SALDOS_AUX_MERGE.sql",
    SR_FOLIO=params.sr_folio,
    hints="/*+ PARALLEL(8) */",
)
execution = db.execute_oci_dml(
