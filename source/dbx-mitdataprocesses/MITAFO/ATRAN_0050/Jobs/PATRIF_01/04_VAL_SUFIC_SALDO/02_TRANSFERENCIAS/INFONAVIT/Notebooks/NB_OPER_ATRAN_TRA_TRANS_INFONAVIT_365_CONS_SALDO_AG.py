...
statement = query.get_statement(
    "TRA_DB_ATRIF_VSS_0100_INFONAVIT_TRANSFER_365_DS_400_DS_500_NSS_AG.sql",
...
statement = query.get_statement(
    "TRA_DB_ATRIF_VSS_0100_INFONAVIT_TRANSFER_365_DS_400_NNS_UNICO.sql",
    sr_folio=params.sr_folio,
)
...
statement = query.get_statement(
    "TRA_DB_ATRIF_VSS_0100_INFONAVIT_TRANSFER_365_DS_400_RejInsSaldos.sql",
    sr_folio=params.sr_folio,
)
