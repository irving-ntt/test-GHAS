...
DELTA_TABLE_DB_700_SUF_SALDOS_363 = "DELTA_TRA_DB_ATRIF_VSS_0100_FOV_TRANSFER_363_" + params.sr_folio
...
db.write_delta(f"DELTA_TRA_DELTA_INSERT_SALDOS_363_{params.sr_folio}", DLTstatement_004, "overwrite")

if conf.debug:
    display(db.read_delta(f"DELTA_TRA_DELTA_INSERT_SALDOS_363_{params.sr_folio}"))
...
db.write_data(db.read_delta(f"DELTA_TRA_DELTA_INSERT_SALDOS_363_{params.sr_folio}"), table_name, "default", "append")

# COMMAND ----------

#query para DS_700_SALDOS_PROC :
DELTA_TABLE_BD_600_TRANS_FOV_363 = "DELTA_TRA_DB_ATRIF_VSS_0100_FOV_TRANSFER_363_" + params.sr_folio
...
db.write_delta(f"DELTA_TRA_DB_ATRIF_363_BD_600_TRANS_FOV_{params.sr_folio}", DLTstatement_003, "overwrite")

if conf.debug:
    display(db.read_delta(f"DELTA_TRA_DB_ATRIF_363_BD_600_TRANS_FOV_{params.sr_folio}"))

# COMMAND ----------

table_name = "CIERREN_DATAUX.TTAFOTRAS_TRANS_FOVISSSTE_AUX"

db.write_data(db.read_delta(f"DELTA_TRA_DB_ATRIF_363_BD_600_TRANS_FOV_{params.sr_folio}"), table_name, "default", "append")
