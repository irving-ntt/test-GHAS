...
statement = query.get_statement(
    "TRA_DB_ATRIF_VSS_0100_INFONAVIT_TRANSFER_364_DS_600_VAL_CUENTAS_REP.sql",
...
statement = query.get_statement(
    "TRA_DB_ATRIF_VSS_0100_INFONAVIT_TRANSFER_364_DS_700_REJ_CUENTAS_REP.sql",
    sr_folio=params.sr_folio,
)
...
statement = query.get_statement(
    "TRA_DB_ATRIF_VSS_0100_INFONAVIT_TRANSFER_364_DS_400_RejInsSaldos_REP.sql",
    sr_folio=params.sr_folio,
)
