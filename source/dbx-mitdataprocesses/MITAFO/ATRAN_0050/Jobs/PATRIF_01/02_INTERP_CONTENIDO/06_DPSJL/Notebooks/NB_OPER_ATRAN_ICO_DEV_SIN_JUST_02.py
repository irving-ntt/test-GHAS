...
Archivos SQL:
    INCO_DPSJL_02_EXT_0100_OCI_LEE_ARCHIVO
    INCO_DPSJL_02_TRN_0200_DBK_TRANSF_INFONAVIT
    DELETE
"""
...
statement = query.get_statement(
    "INCO_DPSJL_02_EXT_0100_OCI_LEE_ARCHIVO.sql",
...
statement = query.get_statement(
    "INCO_DPSJL_02_TRN_0200_DBK_TRANSF_INFONAVIT.sql",
