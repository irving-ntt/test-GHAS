...
Archivos SQL:
    INCO_DES_MAR_CRED_EXT_0100_OCI_LEE_ARCHIVO
    INCO_DES_MAR_CRED_TRN_0200_DBK_LEE_PRE_DIS
"""
...
statement = query.get_statement(
    "INCO_DES_MAR_CRED_EXT_0100_OCI_LEE_ARCHIVO.sql",
...
statement = query.get_statement(
    "INCO_DES_MAR_CRED_TRN_0200_DBK_LEE_PRE_DIS.sql",
...
table_name = "CIERREN_ETL.TTAFOTRAS_ETL_MARCA_DESMARCA"
