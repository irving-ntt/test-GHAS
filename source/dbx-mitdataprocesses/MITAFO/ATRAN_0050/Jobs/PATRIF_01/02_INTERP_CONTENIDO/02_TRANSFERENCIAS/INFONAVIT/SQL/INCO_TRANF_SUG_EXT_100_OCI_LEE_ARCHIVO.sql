...
Trim(SUBSTR(FTC_LINEA,33,8))                FTD_FEH_MOVIMIENTO,
...
((Trim(SUBSTR(FTC_LINEA,475,15)))/ 1000000) FTN_NUM_APLI_INTE_VIVI97_SOL,
((Trim(SUBSTR(FTC_LINEA,490,15)))/ 100)     FTN_SALDO_VIVI97_SOLI,
...
Trim(SUBSTR(FTC_LINEA,650,10))              FTN_NUMERO_CRED_INFONA,
Trim(SUBSTR(FTC_LINEA,713,7))               FTD_PERIODO_PAGO,
Trim(SUBSTR(FTC_LINEA,25,8))                FTD_FEH_VALOR_VIVI
