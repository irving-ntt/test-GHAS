...
Archivos SQL:
    INCO_TRANF_SAG_EXT_100_OCI_LEE_ARCHIVO
    INCO_TRANF_SAG_TRN_200_DBK_TRANSF_INFONAVIT
    DELETE
...
statement = query.get_statement(
    "INCO_TRANF_SAG_EXT_100_OCI_LEE_ARCHIVO.sql",
...
statement = query.get_statement(
    "INCO_TRANF_SAG_TRN_200_DBK_TRANSF_INFONAVIT.sql",
