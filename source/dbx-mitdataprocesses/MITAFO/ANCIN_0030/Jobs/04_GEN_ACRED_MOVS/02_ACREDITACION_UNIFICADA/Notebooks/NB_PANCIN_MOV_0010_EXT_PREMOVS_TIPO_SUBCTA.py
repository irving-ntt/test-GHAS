...
# MAGIC %md
# MAGIC # NB_PANCIN_MOV_0010_EXT_PREMOVS_TIPO_SUBCTA
# MAGIC
...
# MAGIC
# MAGIC **Tablas DELTA:**
# MAGIC - TEMP_TIPO_SUBCTA_{sr_folio}
# MAGIC
# MAGIC **Archivos SQL:**
# MAGIC - NB_PANCIN_MOV_0010_EXT_PREMOVS_OCI_001.sql
# MAGIC
# MAGIC ---
# MAGIC
# MAGIC ## Flujo del Job:
# MAGIC 1. **DB_300**: Extracción de tipo subcuenta desde Oracle
# MAGIC
# MAGIC <li>
...
# MAGIC %md
# MAGIC <li>
# MAGIC   <a href="https://adb-3494755435873649.9.azuredatabricks.net/editor/files/3517236121316582?o=3494755435873649" target="_blank">
# MAGIC     <img src="/Workspace/Repos/APPS/SRC/source/dbx-mitdataprocesses/MITAFO/ANCIN_0030/Jobs/04_GEN_ACRED_MOVS/02_ACREDITACION_UNIFICADA/Notebooks/assets/NB_PANCIN_MOV_0010_EXT_PREMOVS_TIPO_SUBCTA_A.png" style="max-width: 100%; height: auto;"/>
# MAGIC   </a>
# MAGIC </li>
# MAGIC
...
# DBTITLE 1,EXTRAER DATOS DE TIPO SUBCTA (DB_300)
# Cargar query para extraer datos de tipo de subcuenta desde OCI
statement_001 = query.get_statement(
    "NB_PANCIN_MOV_0010_EXT_PREMOVS_OCI_001.sql",
    CX_CRN_ESQUEMA=conf.CX_CRN_ESQUEMA,
    TL_CRN_TIPO_SUBCTA=conf.TL_CRN_TIPO_SUBCTA,
)

# Extraer datos de tipo de subcuenta y guardar en tabla Delta temporal
db.write_delta(
    f"TEMP_TIPO_SUBCTA_{params.sr_folio}", db.read_data("default", statement_001), "overwrite"
)
