...
# MAGIC %md
# MAGIC # NB_PANCIN_MOV_0010_EXT_PREMOVS_VAL_ACCION
# MAGIC
...
# MAGIC
# MAGIC **Tablas Input:**
# MAGIC - CX_CRN_ESQUEMA.TL_CRN_VAL_ACCION
# MAGIC
...
# MAGIC
# MAGIC **Archivos SQL:**
# MAGIC - NB_PANCIN_MOV_0010_EXT_PREMOVS_OCI_004.sql
# MAGIC
# MAGIC ---
# MAGIC
# MAGIC ## Flujo del Job:
# MAGIC 4. **DB_700**: Extracción de valor acción desde Oracle
# MAGIC
# MAGIC <li>
...
# MAGIC %md
# MAGIC <li>
# MAGIC   <a href="https://adb-3494755435873649.9.azuredatabricks.net/editor/files/3517236121316585?o=3494755435873649" target="_blank">
# MAGIC     <img src="/Workspace/Repos/APPS/SRC/source/dbx-mitdataprocesses/MITAFO/ANCIN_0030/Jobs/04_GEN_ACRED_MOVS/02_ACREDITACION_UNIFICADA/Notebooks/assets/NB_PANCIN_MOV_0010_EXT_PREMOVS_VAL_ACCION.png" style="max-width: 100%; height: auto;"/>
# MAGIC   </a>
# MAGIC </li>

# COMMAND ----------

# DBTITLE 4,EXTRAER DATOS DE VALOR ACCION (DB_700)
# Cargar query para extraer datos de valor de acción desde OCI
statement_004 = query.get_statement(
    "NB_PANCIN_MOV_0010_EXT_PREMOVS_OCI_004.sql",
    CX_CRN_ESQUEMA=conf.CX_CRN_ESQUEMA,
    TL_CRN_VALOR_ACCION=conf.TL_CRN_VALOR_ACCION,
)

# Extraer datos de valor de acción y guardar en tabla Delta temporal
db.write_delta(
    f"TEMP_VALOR_ACCION_{params.sr_folio}", db.read_data("default", statement_004), "overwrite"
)
