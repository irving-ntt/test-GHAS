...
# Query para ctualizar VAL_MATRIZ con los datos ya guardadoS de la op65 en TEMP_DELTA_COMUN_MCV_DELTA_16_THAFOGRAL_MAR_DES_ITGY_
...
statement = query.get_statement(
    "DEV_COMUN_MCV_120_TD_03_DEL_VAL_MATRIZ_AUX.sql",
    SR_FOLIO=params.sr_folio,
#    hints="/*+ PARALLEL(8) */",
)
