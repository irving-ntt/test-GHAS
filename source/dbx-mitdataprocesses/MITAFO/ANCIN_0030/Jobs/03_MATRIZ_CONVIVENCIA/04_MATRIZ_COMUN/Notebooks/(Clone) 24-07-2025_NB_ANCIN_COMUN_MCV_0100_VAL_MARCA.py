...
db.write_delta(f"TEMP_DELTA_COMUN_MCV_DELTA_PRE_Y_MATRIZ_01_{params.sr_folio}", db.sql_delta(statement), "overwrite")

if conf.debug:
    display(db.read_delta(f"TEMP_DELTA_COMUN_MCV_DELTA_PRE_Y_MATRIZ_01_{params.sr_folio}"))
...
statement = query.get_statement(
    ...
    sr_folio=params.sr_folio,
    DELTA_TABLA_NAME1 = f"{SETTINGS.GENERAL.CATALOG}.{SETTINGS.GENERAL.SCHEMA}.TEMP_DELTA_COMUN_MCV_DELTA_PRE_Y_MATRIZ_01_{params.sr_folio}",
    DELTA_TABLA_NAME2 = f"{SETTINGS.GENERAL.CATALOG}.{SETTINGS.GENERAL.SCHEMA}.TEMP_DELTA_COMUN_MCV_03_CONF_CONV_{params.sr_folio}",
)
