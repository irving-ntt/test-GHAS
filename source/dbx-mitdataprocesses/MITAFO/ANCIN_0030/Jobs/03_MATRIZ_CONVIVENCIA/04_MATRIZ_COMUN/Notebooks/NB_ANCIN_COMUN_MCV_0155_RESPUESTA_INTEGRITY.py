...
""" 
Descripcion:
     desmarca y actualiza los registros que no convivieron en Integrity, recibido en el archivo 65.
Subetapa: 
...
Tablas input:
    ...
    PROCESOS.TCSISGRAL_MAP_NCI_ITGY_PROCESO        
Tablas output:
    TTAFOGRAL_ETL_MATRIZ_CONVIVENCIA_AUX
    CIERREN.TTAFOGRAL_MATRIZ_CONVIVENCIA (Update/merge)
    CIERREN_ETL.TLSISGRAL_ETL_VAL_MATRIZ_CONV (Update/merge)
Tablas Delta:
    N/A
Archivos SQL:
...
# MAGIC %md
# MAGIC NB_ANCIN_COMUN_MCV_0155_RESPUESTA_INTEGRITY 20251017
