...
#INICIA CÓDIGO DE LARG
query_statement = '016'

params = [sr_folio, sr_folio_rel, sr_tipo_mov ,sr_proceso, sr_subproceso]

delta_name = f"{catalog_name}.{schema_name}.{'DELTA_MVC_01' + '_' + sr_folio}"
DELTA_TABLA1 = delta_name
...
delta_name = f"{catalog_name}.{schema_name}.{'DELTA_MVC_02' + '_' + sr_folio}"
DELTA_TABLA2 = delta_name
...
delta_name = f"{catalog_name}.{schema_name}.{'DELTA_MVC_03' + '_' + sr_folio}"
DELTA_TABLA3 = delta_name
...
#CÓDIGO DE LARG TRANSFORMACIÓN 
query_statement = '019'
params = [DELTA_TABLA1,DELTA_TABLA2,DELTA_TABLA3]

statement, failed_task = getting_statement(conf_values, query_statement, params)

tempView = f"{catalog_name}.{schema_name}.{'DELTA_MVC_04' + '_' + sr_folio}"
DELTA_TABLA4 = tempView
