...
temp_tables = [
    ...
    f"temp_no_vigentes_rechazados_{sr_id_archivo}",
    f"temp_union_final_{sr_id_archivo}",
    f"temp_procesa_identificados_{sr_id_archivo}",
    f"temp_val_ident_cte_{sr_id_archivo}",
    f"temp_union_identificados_{sr_id_archivo}",
    f"temp_cifras_control_{sr_id_archivo}",
    f"temp_no_vigentes_filtrados_{sr_id_archivo}",
    f"temp_marca_0_{sr_id_archivo}",
    f"temp_ctas_aeim_cte_{sr_id_archivo}",
]
