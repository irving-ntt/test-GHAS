...
# Validar widgets
#params.validate()
# Determinar ID de proceso (usa sr_folio si sr_id_archivo == "1")
...
statement_demo_001 = query.get_statement(
    ...
    MAX_LENGTH=conf.VAL_RECORDS_LENGTH_ARCH_RESP_JUST,
...
full_file_name = (
    SETTINGS.GENERAL.EXTERNAL_LOCATION + conf.err_repo_path + "/" + id_proceso  + "_" + conf.output_file_name_002 + ".csv"
)
