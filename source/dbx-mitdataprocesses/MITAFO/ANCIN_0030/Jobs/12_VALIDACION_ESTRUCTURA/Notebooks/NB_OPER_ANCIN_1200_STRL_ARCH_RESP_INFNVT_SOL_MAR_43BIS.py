...
Subetapa:
    Validacion de estructura - INFONAVIT
Tramite:
...
Tablas DELTA:
    delta_001_{params.sr_id_archivo}
    delta_002_{params.sr_id_archivo}
...
dbutils.notebook.exit("Execution aborted.")
...
statement_demo_001 = query.get_statement(
    ...
    MAX_LENGTH=conf.val_records_length_2,
