...
'''
Descripcion:
    Validacion de estructura UG RECHAZADOS
Subetapa:
...
Archivos SQL:
    valid_struct_0001_doissste.sql
    valid_struct_0003_doisste_2.sql
...
statement_demo_001 = query.get_statement(
    ...
    MAX_LENGTH=params.sr_val_records_length,
...
statement_demo_0003 = query.get_statement(
    "VALID_STRUCT_0003_GENERAL_AR_2.sql",
...
statement_demo_0004 = query.get_statement(
    "VALID_STRUCT_0004_GENERAL_AR.sql",
    DELTA_002=SETTINGS.GENERAL.CATALOG
    + "."
    + SETTINGS.GENERAL.SCHEMA
    + "."
...
statement_demo_0005 = query.get_statement(
    "valid_struct_0005_dgimss_2.sql",
    DELTA_002=SETTINGS.GENERAL.CATALOG
    + "."
    + SETTINGS.GENERAL.SCHEMA
    + "."
