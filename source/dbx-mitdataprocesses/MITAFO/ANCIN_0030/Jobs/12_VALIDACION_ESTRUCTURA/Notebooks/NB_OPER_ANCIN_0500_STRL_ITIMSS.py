...
'''
Descripcion:
    Validacion de estructura ITIMSS
Subetapa:
    Validacion de estructura
Tramite:
    121 - Intereses en transito IMSS
Tablas Input:
    NA
Tablas Output:
...
Archivos SQL:
    valid_struct_0001_itimss.sql
    valid_struct_0003_itimss_2.sql
    valid_struct_0004_itimss.sql
...
# DBTITLE 1,CREATE DELTA TABLE 02
