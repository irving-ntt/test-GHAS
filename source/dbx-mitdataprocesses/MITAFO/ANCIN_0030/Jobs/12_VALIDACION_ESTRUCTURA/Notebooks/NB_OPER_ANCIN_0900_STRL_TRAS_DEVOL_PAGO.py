...
statement_demo_001 = query.get_statement(
   ...
   MAX_LENGTH=conf.val_records_length_tras_dev_pag,
...
full_file_name = (
    SETTINGS.GENERAL.EXTERNAL_LOCATION + conf.err_repo_path_tras + "/" + params.sr_id_archivo + "_" + conf.output_file_name_001 + ".csv"
)
