...
# DBTITLE 1,QUERY STATEMENT 0002
#statement_demo_0002 = query.get_statement(
#    "valid_struct_0002_doimss.sql",
...
# DBTITLE 1,OUTPUT STATEMENT 0002
#df_test = db.sql_delta(statement_demo_0002)
#df_test.createOrReplaceTempView(f"temp_view_001_{params.sr_id_archivo}")
#display(df_test)
