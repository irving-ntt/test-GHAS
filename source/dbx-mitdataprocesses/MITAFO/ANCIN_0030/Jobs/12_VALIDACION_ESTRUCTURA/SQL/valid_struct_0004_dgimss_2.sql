WITH
-- 1. Códigos válidos (solo 01, 02, 08, 09)
TIPOS_VALIDOS AS (
...
CONTEO_CUMPLIERON AS (
  ...
  WHERE TE.FTN_NO_LINEA IS NULL
    AND TI.FTC_CONTROL IN ('01', '02', '08', '09')
...
CONTEO_ERRORES AS (
  SELECT 
    RIGHT(DESC_ERROR, 2) AS FLC_DETALLE,
    COUNT(*) AS FLN_TOTAL_ERRORES
  FROM #DELTA_003#
  WHERE RIGHT(DESC_ERROR, 2) IN ('01', '02', '08', '09')
  GROUP BY RIGHT(DESC_ERROR, 2)
),
