SELECT 
    ...
    CASE 
        WHEN FTC_CONTROL = '01' AND SIG_CONTROL = '03' THEN 1
        WHEN FTC_CONTROL = '03' AND (SIG_CONTROL = '03' OR SIG_CONTROL = '08') THEN 1
        WHEN FTC_CONTROL = '08' AND (SIG_CONTROL = '08' OR SIG_CONTROL = '09') THEN 1
