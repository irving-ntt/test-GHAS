SELECT 
    ...
    LEAD(SUBSTRING(FTC_LINEA,1,2)) OVER (PARTITION BY #SR_FOLIO# ORDER BY FTN_NO_LINEA ) SIG_CONTROL,
    LEAD(FTC_LINEA ) OVER (PARTITION BY #SR_FOLIO# ORDER BY FTN_NO_LINEA ) SIG_LINEA,
    CASE 
