SELECT 
    ...
    CASE 
        ...
        WHEN FTC_CONTROL = '02' AND (SIG_CONTROL = '03' OR SIG_CONTROL = '05') THEN 1
        WHEN FTC_CONTROL = '03' AND SIG_CONTROL = '05' THEN 1
        WHEN FTC_CONTROL = '05' AND (SIG_CONTROL = '02' OR SIG_CONTROL = '09') THEN 1
