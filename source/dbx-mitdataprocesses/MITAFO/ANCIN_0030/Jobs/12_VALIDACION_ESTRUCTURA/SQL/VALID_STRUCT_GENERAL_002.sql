...
FROM
    ...
    SELECT
        ...
        ,1
        ,SR_ID_ARCHIVO
    FROM #DELTA_TABLE_NAME_001# TMP
        JOIN (SELECT MAX(FTN_NO_LINEA) FTN_NO_LINEA FROM #DELTA_TABLE_NAME_001#) MAX_REC
    ...
    SELECT
        ...
        ,1
        ,TMP.SR_ID_ARCHIVO
    FROM (SELECT DISTINCT SR_SUBETAPA, SR_ID_ARCHIVO FROM #DELTA_TABLE_NAME_001#) TMP
    JOIN (SELECT COUNT(1) TOTAL FROM #DELTA_TABLE_NAME_001# WHERE FTC_CONTROL = '02') CONTEO
        ON 1 = 1
