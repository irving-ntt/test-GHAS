...
'''
Descripcion:
    Generacion de el archvio de el subproceso 120 - Dispersión Ordinaria ISSSTE VIV92. 
    CTISVI2_20221114_124.DAT - Archivo de dispersión Ordinaria ISSSTE VIV92
Subetapa:
     GENERACIÓN DE ARCHIVO CTINDI
Trámite:
      120 - Dispersión Ordinaria ISSSTE VIV92
Tablas INPUT:
...
Tablas INPUT DELTA:
    N/A
Tablas DELTA:
    TTSISGRAL_ETL_ARCH_CTINDI_VIV92001_[sr_folio]
    TTSISGRAL_ETL_ARCH_CTINDI_VIV92002_[sr_folio]
Tablas OUTPUT DELTA:
    N/A
Archivos SQL:
    ANCIN_GAR_0050_GEN_ARCH_CTINDI_VIV92_001.sql
    ANCIN_GAR_0050_GEN_ARCH_CTINDI_VIV92_002.sql
    ANCIN_GAR_0050_GEN_ARCH_CTINDI_VIV92_003.sql
'''
...
# DBTITLE 1,Definir y validar parametro
params = WidgetParams(
    {
        "sr_folio": str,
        "sr_proceso": str,
...
display(
    queries_df.filter(
        col("Archivo SQL").startswith("ANCIN_GAR_0050_GEN_ARCH_CTINDI_VIV92")
    )
)
...
temp_view = 'TTSISGRAL_ETL_ARCH_CTINDI_VIV92' + '001' + '_' + params.sr_folio
...
temp_view_002 = 'TTSISGRAL_ETL_ARCH_CTINDI_VIV92' + '002' + '_' + params.sr_folio
