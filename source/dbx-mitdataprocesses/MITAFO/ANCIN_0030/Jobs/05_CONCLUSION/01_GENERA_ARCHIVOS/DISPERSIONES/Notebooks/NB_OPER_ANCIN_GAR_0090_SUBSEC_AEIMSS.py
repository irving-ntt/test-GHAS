...
'''
Descripcion:
    Creación de archivo CTINDI para la Dispersión Ordinaria IMSS Subsecuente. 
Subetapa:
    GENERACIÓN DE ARCHIVO CTINDI
Trámite:
      118 - ACLARACIONES ESPECIALES IMSS
Tablas INPUT:
...
Tablas OUTPUT DELTA:
    N/A
Archivos SQL:
    ANCIN_GAR_0090_SUBSEC_AEIMSS.SQL
'''
...
display(
    queries_df.filter(
        col("Archivo SQL").startswith("ANCIN_GAR_0090_SUBSEC_AEIMSS")
    )
)
...
# DBTITLE 1,Creación de archivo subsec AEIMSS
...
#dbutils.fs.cp('abfss://nci-repository@datalakedev1udbvf.dfs.core.windows.net/INTEGRITY/PPA_RCDI02010_20250701_058.DAT', '/Volumes/dbx_mit_dev_1udbvf_workspace/default/doimss_cararch/')
