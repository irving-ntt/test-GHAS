...
'''
Descripcion:
    Generacion de el archvio de el subproceso 122 - Dispersión Intereses en Tránsito ISSSTE. 
    ITRE1_20250609_994.DAT - Archivo de dispersión Intereses en Tránsito ISSSTE
Subetapa:
     GENERACIÓN DE ARCHIVO CTINDI
Trámite:
      122 - Dispersión Intereses en Tránsito ISSSTE
Tablas INPUT:
...
Tablas INPUT DELTA:
    N/A
Tablas DELTA:
    TTSISGRAL_ETL_ITREISSSTE001_[sr_folio]
    TTSISGRAL_ETL_ITREISSSTE002_[sr_folio]
Tablas OUTPUT DELTA:
    N/A
Archivos SQL:
    ANCIN_GAR_0030_GEN_ARCH_ITREISSSTE_001.sql
    ANCIN_GAR_0030_GEN_ARCH_ITREISSSTE_002.sql
    ANCIN_GAR_0030_GEN_ARCH_ITREISSSTE_003.sql
'''
...
display(
    queries_df.filter(
        col("Archivo SQL").startswith("ANCIN_GAR_0030_GEN_ARCH_ITREISSSTE")
    )
)
...
statement_001 = query.get_statement("ANCIN_GAR_0030_GEN_ARCH_ITREISSSTE_001.sql",
...
temp_view = 'TTSISGRAL_ETL_ITREISSSTE' + '001' + '_' + params.sr_folio
...
statement_002 = query.get_statement( "ANCIN_GAR_0030_GEN_ARCH_ITREISSSTE_002.sql",
...
temp_view_002 = 'TTSISGRAL_ETL_ITREISSSTE' + '002' + '_' + params.sr_folio
