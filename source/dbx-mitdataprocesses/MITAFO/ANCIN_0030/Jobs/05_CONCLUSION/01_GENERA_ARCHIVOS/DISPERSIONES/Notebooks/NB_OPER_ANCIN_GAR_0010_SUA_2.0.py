...
full_file_name_md5 = external_location + err_repo_path + "/MD5_SUA_" + fecha_actual + "_" + sr_sec_lote + ".DAT.md5"

full_path = "/Volumes/" + catalog_name + "/" +  schema_name + "/doimss_carga_archivo/SUA_" + fecha_actual + "_" + sr_sec_lote
