...
'''
Descripcion:
    Generacion de el archvio de el subproceso 439 - Dispersión Gubernamental IMSS. 
    CTINDI1_YYYYMMDD_002.DAT - Archivo de dispersión gubernamental IMSS
Subetapa:
     GENERACIÓN DE ARCHIVO CTINDI
Trámite:
      439 - Dispersión Gubernamental IMSS
Tablas INPUT:
...
Tablas INPUT DELTA:
    N/A
Tablas DELTA:
    TTSISGRAL_ETL_GOBIMSS001_[sr_folio]
    TTSISGRAL_ETL_GOBIMSS002_[sr_folio]
Tablas OUTPUT DELTA:
    N/A
Archivos SQL:
    ANCIN_GAR_0030_GEN_ARCH_GOBIMSS_003.sql
    ANCIN_GAR_0030_GEN_ARCH_GOBIMSS_002.sql
    ANCIN_GAR_0030_GEN_ARCH_GOBIMSS_001.sql
'''
...
display(
    queries_df.filter(
        col("Archivo SQL").startswith("ANCIN_GAR_0030_GEN_ARCH_GOB")
    )
)
...
temp_view = 'TTSISGRAL_ETL_GOBIMSS' + '001' + '_' + params.sr_folio
