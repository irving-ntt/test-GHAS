...
'''
Descripcion:
    Generacion de el archvio de el subproceso 118 - Dispersión de aclaraciones especiales IMSS. 
    CTINDI1_20250219_003.DAT - Archivo de dispersión de aclaraciones especiales IMSS   
Subetapa:
     GENERACIÓN DE ARCHIVO CTINDI
Trámite:
      118 - Dispersión de aclaraciones especiales IMSS
Tablas INPUT:
...
Tablas INPUT DELTA:
    N/A
Tablas DELTA:
    TTSISGRAL_ETL_ACLAR_ESPE001_[sr_folio]
    TTSISGRAL_ETL_ACLAR_ESPE002_[sr_folio]
Tablas OUTPUT DELTA:
    N/A
Archivos SQL:
    ANCIN_GAR_0080_GEN_ARCH_ACLAR_ESPECIALES_001.sql
    ANCIN_GAR_0080_GEN_ARCH_ACLAR_ESPECIALES_002.sql
    ANCIN_GAR_0080_GEN_ARCH_ACLAR_ESPECIALES_003.sql
'''
...
display(
    queries_df.filter(
        col("Archivo SQL").startswith("ANCIN_GAR_0080_GEN_ARCH_ACL")
    )
)
...
temp_view = 'DELTA_TTSISGRAL_ETL_ACLAR_ESPE' + '001' + '_' + params.sr_folio
...
temp_view_002 = 'DELTA_TTSISGRAL_ETL_ACLAR_ESPE' + '002' + '_' + params.sr_folio
