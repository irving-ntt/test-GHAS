...
'''
Descripcion:
    Generacion de el archvio de el subproceso 120 - Dispersión Ordinaria ISSSTE VIV98. 
    CTISVI8_20240816_127.DAT - Archivo de dispersión Ordinaria ISSSTE VIV98
Subetapa:
     GENERACIÓN DE ARCHIVO CTINDI
Trámite:
      120 - Dispersión Ordinaria ISSSTE VIV98
Tablas INPUT:
...
Tablas INPUT DELTA:
    N/A
Tablas DELTA:
    TTSISGRAL_ETL_ARCH_CTINDI_VIV98001_[sr_folio]
    TTSISGRAL_ETL_ARCH_CTINDI_VIV98002_[sr_folio]
Tablas OUTPUT DELTA:
    N/A
Archivos SQL:
    ANCIN_GAR_0040_GEN_ARCH_CTINDI_VIV98_001.sql
    ANCIN_GAR_0040_GEN_ARCH_CTINDI_VIV98_002.sql
    ANCIN_GAR_0040_GEN_ARCH_CTINDI_VIV98_003.sql
'''
...
display(
    queries_df.filter(
        col("Archivo SQL").startswith("ANCIN_GAR_0040_GEN_ARCH_CTINDI")
    )
)
...
temp_view = 'TTSISGRAL_ETL_ARCH_CTINDI_VIV98' + '001' + '_' + params.sr_folio
...
temp_view_002 = 'TTSISGRAL_ETL_ARCH_CTINDI_VIV98' + '002' + '_' + params.sr_folio
