...
'''
Descripcion:
    Generacion de el archvio de el subproceso 120 - Dispersión Ordinaria ISSSTE RCV. 
    CTISRCV_20221114_128.DAT - Archivo de dispersión Ordinaria ISSSTE RCV
Subetapa:
     GENERACIÓN DE ARCHIVO CTINDI
Trámite:
      120 - Dispersión Ordinaria ISSSTE RCV
Tablas INPUT:
...
Tablas INPUT DELTA:
    N/A
Tablas DELTA:
    TTSISGRAL_ETL_CTINDI_RCV001_[sr_folio]
    TTSISGRAL_ETL_CTINDI_RCV002_[sr_folio]
Tablas OUTPUT DELTA:
    N/A
Archivos SQL:
    ANCIN_GAR_0030_GEN_ARCH_CTINDI_RCV_001.sql
    ANCIN_GAR_0030_GEN_ARCH_CTINDI_RCV_002.sql
    ANCIN_GAR_0030_GEN_ARCH_CTINDI_RCV_003.sql
'''
...
display(
    queries_df.filter(
        col("Archivo SQL").startswith("ANCIN_GAR_0030_GEN_ARCH_CTINDI_RCV")
    )
)
...
temp_view = 'TTSISGRAL_ETL_CTINDI_RCV' + '001' + '_' + params.sr_folio
...
temp_view_002 = 'TTSISGRAL_ETL_CTINDI_RCV' + '002' + '_' + params.sr_folio
