...
# DBTITLE 1,Construcción de Consulta SUA
statement_001 = query.get_statement(
    "GAR_0010_GEN_ARCH_CTINDI_SUA_003.sql",
    SR_FOLIO=params.sr_folio
)

# COMMAND ----------

# DBTITLE 1,Extracción de tabla SUA
...
temp_view = 'DELTA_DOIMSS_CTI_03_SUA_' + params.sr_folio
