...
'''
Descripcion:
    Generacion de el archvio de el subproceso 121 - Dispersión Intereses en tránsito IMSS. 
    ITRE1_2022110_994.DAT - Archivo de dispersión Intereses en tránsito IMSS
Subetapa:
     GENERACIÓN DE ARCHIVO CTINDI
Trámite:
      121 - Dispersión Intereses en tránsito IMSS
Tablas INPUT:
...
Tablas INPUT DELTA:
    N/A
Tablas DELTA:
    TTSISGRAL_ETL_ITREIMSS001_[sr_folio]
    TTSISGRAL_ETL_ITREIMSS002_[sr_folio]
Tablas OUTPUT DELTA:
    N/A
Archivos SQL:
    ANCIN_GAR_0030_GEN_ARCH_ITREIMSS_001.sql
    ANCIN_GAR_0030_GEN_ARCH_ITREIMSS_002.sql
    ANCIN_GAR_0030_GEN_ARCH_ITREIMSS_003.sql
'''
...
display(
    queries_df.filter(
        col("Archivo SQL").startswith("ANCIN_GAR_0030_GEN_ARCH_ITREIMSS")
    )
)
...
temp_view = 'TTSISGRAL_ETL_ITREIMSS' + '001' + '_' + params.sr_folio
...
temp_view_002 = 'TTSISGRAL_ETL_ITREIMSS' + '002' + '_' + params.sr_folio
