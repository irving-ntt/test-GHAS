SELECT
  ...
  ,CASE WHEN substr(FTC_LINEA,1,2) = '01' then NULL else substr(FTC_LINEA,1,2) end Error_en_campo_Tipo_de_registro_diferente_a_01
	...
	,CASE WHEN substr(FTC_LINEA,5,2) = '15' then NULL else substr(FTC_LINEA,5,2) end Error_en_campo_Identificador_de_operacion_diferente_a_15
	...
	,CASE WHEN substr(FTC_LINEA,14,3) = '534' then NULL else substr(FTC_LINEA,14,3) end Error_en_campo_Clave_de_entidad_destino_diferente_a_534_
