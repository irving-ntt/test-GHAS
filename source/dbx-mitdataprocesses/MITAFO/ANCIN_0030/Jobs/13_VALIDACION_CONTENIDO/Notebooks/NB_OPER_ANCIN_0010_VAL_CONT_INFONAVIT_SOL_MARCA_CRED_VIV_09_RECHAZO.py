...
'''
Descripción:
    Realiza la validación de contenido del archivo de INFONAVIT Solicitud de marca
Subetapa:
    Validación de contenido
Trámite:
    INFONAVIT Solicitud de marca
Tablas Input:
    N/A
Tablas Output:
    N/A
...
Archivos SQL:
    "VAL_CONT_INFONAVIT_SOL_MARCA_CRED_VIV_09_001.sql"
'''
...
statement_001 = query.get_statement(
    "VAL_CONT_INFONAVIT_SOL_MARCA_CRED_VIV_09_001_RECHAZO.sql",
