...
'''
Descripción:
    Realiza la validación de contenido del archivo de Devolución de Pagos sin Justificacion Legal
Subetapa:
    Validación de contenido
Trámite:
    Devolución de Pagos sin Justificacion Legal
Tablas Input:
    N/A
Tablas Output:
    N/A
...
Archivos SQL:
    VAL_CONT_INFONAVIT_DEV_PAG_SIN_JUSTIF_LEGAL_0X_001.sql
'''
...
sql_file = "VAL_CONT_INFONAVIT_DEV_PAG_SIN_JUSTIF_LEGAL_" + ETAPA + "_001.sql"
