...
'''
Descripcion:
    Realiza la validación de contenido del archivo de ITISSSTE para el archivo de respuesta
Subetapa:
    Validación de contenido
Tramite:
    ITISSSTE archivo de respuesta
Tablas Input:
    N/A
Tablas Output:
    N/A
...
Archivos SQL:
    "VAL_CONT_INFONAVIT_ARCH_RESP_ITISSSTE_02_001.sql"
'''
