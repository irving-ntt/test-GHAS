...
'''
Descripción:
    Realiza la validación de contenido del archivo de INFONAVIT Solicitud de uso de garantia
Subetapa:
    Validación de contenido
Trámite:
    INFONAVIT Solicitud de uso de garantia
Tablas Input:
    N/A
Tablas Output:
    N/A
...
Archivos SQL:
    "VAL_CONT_INFONAVIT_SOL_USO_GAR_09_001.sql"
'''
...
statement_001 = query.get_statement(
    "VAL_CONT_INFONAVIT_SOL_USO_GAR_09_001_RECHAZO.sql",
