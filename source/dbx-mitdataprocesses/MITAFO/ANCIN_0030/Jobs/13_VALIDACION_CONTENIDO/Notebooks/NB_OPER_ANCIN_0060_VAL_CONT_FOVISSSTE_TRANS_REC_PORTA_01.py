...
'''
Descripción:
    Realiza la validación de contenido del archivo de TRANSFERENCIA DE RECURSOS POR PORTABILIDAD
Subetapa:
...
Archivos SQL:
    VAL_CONT_FOVISSSTE_TRANS_REC_PORTA_0X_001.sql
'''
...
sql_file = "VAL_CONT_FOVISSSTE_TRANS_REC_PORTA_" + ETAPA + "_001.sql"
