...
Archivos SQL:
    VAL_CONT_INFONAVIT_USO_GAR_43_BIS_ACEP_0X_001.sql
    VAL_CONT_INFONAVIT_USO_GAR_43_BIS_RECH_0X_001.sql
'''
...
sql_file = ("VAL_CONT_INFONAVIT_USO_GAR_43_BIS_RECH_" + ETAPA + "_001.sql" if "DEVUSOG43.TXT" in params.sr_path_arch.upper() else "VAL_CONT_INFONAVIT_USO_GAR_43_BIS_ACEP_" + ETAPA + "_001.sql")
