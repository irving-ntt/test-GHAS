...
'''
Descripción:
    Realiza la validación de contenido del archivo de INFONAVIT Devolución de saldos excedentes de vivienda UG
Subetapa:
    Validación de contenido
Trámite:
    INFONAVIT Devolución de saldos excedentes de vivienda UG
Tablas Input:
    N/A
Tablas Output:
    N/A
...
Archivos SQL:
    "VAL_CONT_INFONAVIT_DEV_SAL_EX_VIV_UG_02_001.sql"
'''
...
DELTA_TABLE_001 = "DELTA_VALIDA_CONTENIDO_" + params.sr_folio
...
statement_001 = query.get_statement(
    "VAL_CONT_INFONAVIT_DEV_SAL_EX_VIV_UG_02_001_INTGRTY.sql",
...
ETAPA='02'
statement_001=''
DELTA_TABLE_CLEANED_001 = "DELTA_VALIDA_CONTENIDO_CIFRAS_CONTROL_ERR_" + ETAPA + "_" + params.sr_folio

#len(df_cleaned.columns) depende de los valores fijos como FTN_NO_LINEA, ID_ARCHIVO
if len(df_cleaned.take(1)) == 1 and len(df_cleaned.columns) > 1:
    full_path = SETTINGS.GENERAL.EXTERNAL_LOCATION + SETTINGS.GENERAL.PATH_INTEGRITY + '/' + SETTINGS.GENERAL.PATH_INF + '/' + os.path.basename(params.sr_path_arch) + f'_{ETAPA}_INCIDENCIAS.csv'
...
DELTA_TABLE_NAME_002 = "DELTA_VALIDA_CONTENIDO_CIFRAS_CONTROL_" + params.sr_folio
