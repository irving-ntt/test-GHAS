...
'''
Descripción:
    Realiza la validación de contenido del archivo de INFONAVIT Solicitud de transferencia
Subetapa:
    Validación de contenido
Trámite:
    INFONAVIT Solicitud de transferencia
Tablas Input:
    N/A
Tablas Output:
    N/A
...
Archivos SQL:
    "VAL_CONT_INFONAVIT_SOL_TRANS_01_001.sql"
'''
...
statement_001 = query.get_statement(
    "VAL_CONT_INFONAVIT_SOL_TRANS_ANUAL_02_001_RECHAZO.sql",
