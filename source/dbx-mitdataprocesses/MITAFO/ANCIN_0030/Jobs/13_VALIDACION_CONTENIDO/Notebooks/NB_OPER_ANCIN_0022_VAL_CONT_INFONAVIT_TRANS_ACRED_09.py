...
Archivos SQL:
    VAL_CONT_INFONAVIT_TRANS_ACRED_ACEP_0X_001.sql
    VAL_CONT_INFONAVIT_TRANS_ACRED_RECH_0X_001.sql
'''
...
sql_file = ("VAL_CONT_INFONAVIT_TRANS_ACRED_RECH_" + ETAPA + "_001.sql" if "TRADEV.TXT" in params.sr_path_arch.upper() else "VAL_CONT_INFONAVIT_TRANS_ACRED_ACEP_" + ETAPA + "_001.sql")
