...
'''
Descripción:
    Realiza la validación de contenido del archivo de TRANSFERENCIAS DE ACREDITADOS FOVISSSTE
Subetapa:
...
Archivos SQL:
    VAL_CONT_FOVISSSTE_TRANS_ACRED_0X_001.sql
'''
...
sql_file = "VAL_CONT_FOVISSSTE_TRANS_ACRED_" + ETAPA + "_001.sql"
