...
# DBTITLE 1,VALIDACION 02
#Ejecuta consulta para el 02
#Genera la consulta y le pasa los parametros
statement_001 = query.get_statement(
    "VAL_CONT_DOIMSS_02_001.sql",
...
if len(df_cleaned.take(1)) == 1 and len(df_cleaned.columns) > 1:
    full_path = SETTINGS.GENERAL.EXTERNAL_LOCATION + params.sr_path_arch + f'_{ETAPA}_INCIDENCIAS.csv'
...
#dbutils.fs.cp('abfss://nci-repository@datalakedev1udbvf.dfs.core.windows.net/RCDI/IN/PREFT.DP.P01534.F240429.DISPAF.C405.DAT_02_INCIDENCIAS.csv','/Volumes/dbx_mit_dev_1udbvf_workspace/default/doimss_cararch/')
#dbutils.fs.rm('abfss://nci-repository@datalakedev1udbvf.dfs.core.windows.net/RCDI/IN/PREFT.DP.P01534.F240429.DISPAF.C405.DAT_01_INCIDENCIAS.csv')
#dbutils.fs.cp('/Volumes/dbx_mit_dev_1udbvf_workspace/default/doimss_cararch/PTCFT.DP.A01534.S241017.O15TA.C002.dat', 'abfss://nci-repository@datalakedev1udbvf.dfs.core.windows.net/RCDI/IN/')
#dbutils.fs.cp('/Volumes/dbx_mit_dev_1udbvf_workspace/default/doimss_cararch/PREFT.DP.P01534.F240429.DISPAF.C405.DAT', 'abfss://nci-repository@datalakedev1udbvf.dfs.core.windows.net/RCDI/IN/')
