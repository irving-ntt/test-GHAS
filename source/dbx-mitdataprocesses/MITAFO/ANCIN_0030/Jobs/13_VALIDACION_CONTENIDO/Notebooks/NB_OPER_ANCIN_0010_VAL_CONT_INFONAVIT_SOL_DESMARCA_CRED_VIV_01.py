...
'''
Descripción:
    Realiza la validación de contenido del archivo de INFONAVIT Solicitud de desmarca
Subetapa:
    Validación de contenido
Trámite:
    INFONAVIT Solicitud de desmarca
Tablas Input:
    N/A
Tablas Output:
    N/A
...
Archivos SQL:
    "VAL_CONT_INFONAVIT_SOL_DESMARCA_CRED_VIV_01_001.sql"
    /Volumes/dbx_mit_dev_1udbvf_workspace/default/doimss_cararch/enviado_mike_PTCFT.DP.A01534.S250331.O01DM.C002.DAT
'''
...
statement_001 = query.get_statement(
    ...
    sr_path_arch=params.sr_path_arch
)
