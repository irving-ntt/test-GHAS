...
Archivos SQL:
    VAL_CONT_INFONAVIT_TRANS_ANUAL_GARAN_ACEP_0X_001
    VAL_CONT_INFONAVIT_TRANS_ANUAL_GARAN_RECH_0X_001
'''
...
sql_file = ("VAL_CONT_INFONAVIT_TRANS_ANUAL_GARAN_RECH_" + ETAPA + "_001.sql" if "DEV.TXT" in params.sr_path_arch.upper() else "VAL_CONT_INFONAVIT_TRANS_ANUAL_GARAN_ACEP_" + ETAPA + "_001.sql")
