...
Archivos SQL:
    "VAL_CONT_FOVISSTE_TRANS_ACRE_01_001.sql"
'''
...
subprocesos_rctras = {'354', '364', '365', '368', '348', '349', '363', '3286', '350', '347', '3283'} #quitar el 3832
subprocesos_intgrty = {'354', '364', '365', '368', '348', '349', '363', '3286', '350', '347', '3283', '3832'}

id_proceso = params.sr_id_archivo if params.sr_id_archivo != "1" else params.sr_folio

if params.sr_subproceso in subprocesos_rctras and params.sr_subetapa == "23":
