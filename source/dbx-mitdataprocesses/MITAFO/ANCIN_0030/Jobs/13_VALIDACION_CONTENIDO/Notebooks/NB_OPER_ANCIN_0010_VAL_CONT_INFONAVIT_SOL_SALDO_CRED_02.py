...
'''
Descripción:
    Realiza la validación de contenido del archivo de INFONAVIT Solicitud de saldo de crédito
Subetapa:
    Validación de contenido
Trámite:
    INFONAVIT Solicitud de saldo de crédito
Tablas Input:
    N/A
Tablas Output:
    N/A
...
Archivos SQL:
    "VAL_CONT_INFONAVIT_SOL_SALDO_CRED_02_001.sql"
'''
