...
'''
Descripcion:
    Realiza la validación de contenido del archivo de DOISSSTE para el archivo de respuesta
Subetapa:
    Validación de contenido
Tramite:
    DOISSSTE archivo de respuesta
Tablas Input:
    N/A
Tablas Output:
    N/A
...
Archivos SQL:
    "VAL_CONT_INFONAVIT_ARCH_RESP_DOISSSTE_09_001.sql"
'''
