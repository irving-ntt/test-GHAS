...
'''
Descripcion:
    Realiza la validación de contenido del archivo de ACLESP para el archivo de respuesta
Subetapa:
    Validación de contenido
Tramite:
    ACLESP archivo de respuesta
Tablas Input:
    N/A
Tablas Output:
    N/A
...
Archivos SQL:
    "VAL_CONT_INFONAVIT_ARCH_RESP_ACLESP_03_001.sql"
'''
