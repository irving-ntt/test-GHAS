...
statement = query.get_statement(
    "INCO_AEIM_EXT_100_OCI_INT_LEE_ARCHIVO.sql",
...
statement = query.get_statement(
    "INCO_AEIM_EXT_400_OCI_INT_LEE_ARCHIVO.sql",
    sr_id_archivo=params.sr_id_archivo,
)

db.write_delta(f"DELTA_INCO_08_{params.sr_folio}", db.read_data("default", statement), "overwrite")

if conf.debug:
    display(db.read_delta(f"DELTA_INCO_08_{params.sr_folio}"))