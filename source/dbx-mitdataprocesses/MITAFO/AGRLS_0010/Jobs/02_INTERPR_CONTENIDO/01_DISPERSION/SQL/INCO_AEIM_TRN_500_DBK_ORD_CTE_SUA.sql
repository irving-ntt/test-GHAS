SELECT 
   ...
   --CAST(SUBSTRING(FNN_ULTIMO_SALARIO_INT_PER, 1, 5) AS DECIMAL(10,2)) AS FNN_ULTIMO_SALARIO_INT_PER,
    ...
    FNC_FOLIO_PAGO_SUA AS FNC_FOLIO_PAGO_SUA,
    ...
    --CAST(CONCAT(SUBSTRING(FTC_APLIC_INTERES_VIVIENDA, 1, 9), '.', RIGHT(FTC_APLIC_INTERES_VIVIENDA, 6)) AS DECIMAL(15,6)) AS FNN_APLIC_INT_VIVIENDA,
   -- Se aplica la validación al campo FNN_APLIC_INT_VIVIENDA para que el resultado concida con el resultado en MIT
    CASE WHEN CAST(FTC_APLIC_INTERES_VIVIENDA AS DECIMAL(20,6)) > 999999999 THEN 0 ELSE FTC_APLIC_INTERES_VIVIENDA end FNN_APLIC_INT_VIVIENDA,
    FNC_MOTIVO_LIBCION_APORT AS FNC_MOTIVO_LIBCION_APORT,
