...
'''
Descripcion:
    Generación de la Tabla DELTA200 para el trámite 120 y 122
Subetapa:
...
Tablas OUTPUT:
    N/A
Tablas INPUT DELTA:
    DELTA_ACLARACIONES_ESPECIALES_100_SALIDA_#SR_ID_ARCHIVO#
Tablas OUTPUT DELTA:
    DELTA_ACLARACIONES_ESPECIALES_200_#SR_ID_ARCHIVO#
Archivos SQL:
    ACLARACIONES_ESPECIALES_002.sql
'''
...
DELTA_TABLE_002 = "DELTA_ACLARACIONES_ESPECIALES_100_SALIDA_" + params.sr_id_archivo
...
statement_001 = query.get_statement(
    ...
    DELTA_TABLE_001=f"{SETTINGS.GENERAL.CATALOG}.{SETTINGS.GENERAL.SCHEMA}.{DELTA_TABLE_002}"
)

#Ejecuta la consulta sobre la delta
df = db.sql_delta(statement_001)

db.write_delta(DELTA_TABLE_200, df, "overwrite")

# COMMAND ----------

# DBTITLE 1,Tabla 200 ISSSTE
if conf.debug:
    display(df)
