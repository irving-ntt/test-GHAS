...
'''
Descripcion:
    Generación de la Tabla DELTA400 para el trámite 120 y 122
Subetapa:
...
Archivos SQL:
    ACLARACIONES_ESPECIALES_ISSSTE_006.sql
'''
...
db.write_delta(DELTA_TABLE_400, df, "overwrite")

# COMMAND ----------

# DBTITLE 1,Tabla Resultante 400 ISSSTE
if conf.debug:
    display(df)
