...
'''
Descripcion:
    Generación de la Tabla DELTA500 para el trámite 120 y 122
Subetapa:
...
Archivos SQL:
    ACLARACIONES_ESPECIALES_ISSSTE_004.sql
'''
...
DELTA_TABLE_001 = "DELTA_ACLARACIONES_ESPECIALES_100_SALIDA_" + params.sr_id_archivo
...
db.write_delta(DELTA_TABLE_500, df, "overwrite")

# COMMAND ----------

# DBTITLE 1,Tabla Resultante 500 ISSSTE
if conf.debug:
    display(df)
