...
'''
Descripcion:
    Carga inicial de datos para la generación de archivos TTSISGRAL_ETL_LEE_ARCHIVO
Subetapa:
...
Archivos SQL:
    ACLARACIONES_ESPECIALES_006.sql
'''
...
DELTA_TABLE_001 = "DELTA_ACLARACIONES_ESPECIALES_LEE_ARCH_" + params.sr_id_archivo
